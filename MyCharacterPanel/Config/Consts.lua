...
addon.Consts.SLOTS_LAYOUT = {
    ...
    [10] = { "RIGHT", -30, START_Y, "SLOT_HAND" },
    [6]  = { "RIGHT", -30, START_Y - STEP_Y, "SLOT_WAIST" },
    [7]  = { "RIGHT", -30, START_Y - (STEP_Y * 2), "SLOT_LEGS" },
    [8]  = { "RIGHT", -30, START_Y - (STEP_Y * 3), "SLOT_FEET" },
    [11] = { "RIGHT", -30, START_Y - (STEP_Y * 4), "SLOT_FINGER1" },
    [12] = { "RIGHT", -30, START_Y - (STEP_Y * 5), "SLOT_FINGER2" },
    [13] = { "RIGHT", -30, START_Y - (STEP_Y * 6), "SLOT_TRINKET1" },
    [14] = { "RIGHT", -30, START_Y - (STEP_Y * 7), "SLOT_TRINKET2" },
