...
L["CREDITS_NEXUS"] = "Obrigado a NexuswOw pelo desenvolvimento"

-- ==============================================================================
-- New Features (Update) & Reset
-- ==============================================================================
L["RESET_STATS"] = "Redefinir estatísticas"
L["RESET_STATS_DESC"] = "Redefine a ordem das estatísticas para a configuração padrão."
L["MAJ_TITLE"] = "Novidades - Versão %s"
L["MAJ_FEATURE_1"] = "- Drag & Drop: Arraste e solte suas estatísticas para reordená-las!"
L["MAJ_FEATURE_2"] = "- Valvo por personagem: Cada personagem agora tem sua própria configuração."
L["MAJ_FEATURE_3"] = "- Correção API iLvl"
L["MAJ_FEATURE_4"] = "- Zoom: Hold CTRL + Mouse Wheel to adjust interface size (50% to 150%)"
L["MAJ_FEATURE_5"] = "- Correção: Aplicação de óleo/encantamento em armas reparada"
L["TITLE_RESET_SECTION"] = "Restaurar configurações padrão"
