...
-- Fichier de traduction pour la langue enGB
...
L["CREDITS_NEXUS"] = "Thanks to NexuswOw for the Ilvl fix"

-- ==============================================================================
-- Update Notes (MAJ) & Reset
-- ==============================================================================
L["RESET_STATS"] = "Reset Statistics Order"
L["RESET_STATS_DESC"] = "Resets the statistics order to default configuration."
L["MAJ_TITLE"] = "What's New - Version %s"
L["MAJ_FEATURE_1"] = "- Drag & Drop: Drag and drop your statistics to reorganize them!"
L["MAJ_FEATURE_2"] = "- Per-Character Save: Each character now has its own configuration."
L["MAJ_FEATURE_3"] = "- API fix for iLVL"
